...
Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.2"
  spec.summary      = "Elegant way to layout a table with Swift enum."
  ...
  # Or just: spec.author    = "iMoe"
  # spec.authors            = { "iMoe" => "iMoeNya@outlook.com" }
  # spec.social_media_url   = "https://twitter.com/iMoe"
